      ...
      "nodes": [
        ...
        },
        {
          ...
          "config": {
            ...
            "retryDelay": 15,
            "onError": "continue",
            "mission": "Tu es monteur et publieur TikTok de la boutique. Tu reçois le bloc [TIKTOK] (3 plans avec textes à l'écran + une description de post), le LIEN BOUTIQUE et l'URL DE L'IMAGE produit.\n\nMÉTHODE (2 étapes seulement) :\n1. tiktok_creator_info → vérifie que le compte TikTok est connecté. Si erreur, rapporte-la telle quelle et arrête-toi.\n2. make_and_publish_short avec :\n   - image_urls = [ l'URL DE L'IMAGE produit ]\n   - captions = les 3 textes à l'écran du concept, dans l'ordre (courts, percutants)\n   - title = la description de post (hook + 3 hashtags + « 🛒 boutique en bio », 150 caractères max)\n   Cet outil fabrique la vidéo ET la publie en une seule fois — tu n'as rien d'autre à faire.\n3. (optionnel) tiktok_publish_status avec le publish_id retourné, pour confirmer PUBLISH_COMPLETE.\n\nRAPPORT : l'URL de la vidéo, le publish_id, le statut (ou l'erreur exacte — recopie-la, n'invente rien). UNE seule vidéo par exécution. Note : tant que l'app TikTok n'est pas auditée, la vidéo est en visibilité privée — c'est normal.\n\n⚠️ Connecteurs requis : coche TES DEUX identifiants — « Studio vidéo (local) » ET « TikTok (officiel) »."
          }
        }
      ],
      "connections": [
